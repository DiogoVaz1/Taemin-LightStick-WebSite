...
const I18N = {
  ...
  en: {
    ...
    announce_body:  'It works very differently from the last one, so we\'re looking into whether we can support it. No promises yet - we\'ll keep you posted!',
    ...
    studio_help_title:          '⌨️ Shortcuts & commands',
    studio_help_k_space:        'Space',
    studio_help_d_space:        'Play / pause the video',
    studio_help_k_rclick_track: 'Right-click timeline',
    studio_help_d_rclick_track: 'Add a color segment',
    studio_help_k_rclick_seg:   'Right-click a segment',
    studio_help_d_rclick_seg:   'Change color, effects, brightness or delete',
    studio_help_k_drag:         'Drag a segment',
    studio_help_d_drag:         'Move it along the timeline',
    studio_help_k_ctrldrag:     'Ctrl + drag',
    studio_help_d_ctrldrag:     'Move freely, without snapping to neighbors',
    studio_help_d_delete:       'Delete the selected segment(s)',
    studio_help_k_ctrlclick:    'Ctrl + click',
    studio_help_d_ctrlclick:    'Select multiple segments',
    studio_help_d_copy:         'Copy / paste segments at the cursor',
    studio_help_k_ruler:        'Drag the ruler',
    studio_help_d_ruler:        'Pan the timeline · click to seek',
    studio_help_mobile:         "⚠️ Keyboard, right-click and Ctrl shortcuts aren't available on phones. On mobile: tap the 🎨 button to add a color, tap a segment to select it, and long-press a segment for options (color, effects, delete). For the full experience, use a computer with a keyboard and mouse.",
  ...
  pt: {
    ...
    announce_body:  'Funciona de forma muito diferente do anterior, por isso estamos a investigar se conseguimos dar-lhe suporte. Ainda sem promessas - vamos mantendo-te a par!',
    ...
    studio_help_title:          '⌨️ Atalhos e comandos',
    studio_help_k_space:        'Espaço',
    studio_help_d_space:        'Play / pausa do vídeo',
    studio_help_k_rclick_track: 'Botão direito na barra',
    studio_help_d_rclick_track: 'Adicionar um segmento de cor',
    studio_help_k_rclick_seg:   'Botão direito num segmento',
    studio_help_d_rclick_seg:   'Mudar cor, efeitos, brilho ou eliminar',
    studio_help_k_drag:         'Arrastar um segmento',
    studio_help_d_drag:         'Mover ao longo da timeline',
    studio_help_k_ctrldrag:     'Ctrl + arrastar',
    studio_help_d_ctrldrag:     'Mover livremente, sem colar aos vizinhos',
    studio_help_d_delete:       'Eliminar o(s) segmento(s) selecionado(s)',
    studio_help_k_ctrlclick:    'Ctrl + clique',
    studio_help_d_ctrlclick:    'Selecionar vários segmentos',
    studio_help_d_copy:         'Copiar / colar segmentos no cursor',
    studio_help_k_ruler:        'Arrastar a régua',
    studio_help_d_ruler:        'Deslocar a timeline · clicar para saltar',
    studio_help_mobile:         '⚠️ Os atalhos de teclado, botão direito e Ctrl não estão disponíveis no telemóvel. No telemóvel: toca no botão 🎨 para adicionar uma cor, toca num segmento para o selecionar e mantém premido para ver as opções (cor, efeitos, eliminar). Para a melhor experiência, usa um computador com teclado e rato.',
  ...
  ko: {
    ...
    announce_body:  '이전 모델과 작동 방식이 많이 달라서 지원 가능 여부를 알아보는 중입니다. 아직 확답은 드리기 어렵지만 소식을 전해드릴게요!',
    announce2_badge: '테마',
    ...
    studio_help_title:          '⌨️ 단축키 및 명령',
    studio_help_k_space:        '스페이스바',
    studio_help_d_space:        '동영상 재생 / 일시정지',
    studio_help_k_rclick_track: '타임라인 우클릭',
    studio_help_d_rclick_track: '색상 세그먼트 추가',
    studio_help_k_rclick_seg:   '세그먼트 우클릭',
    studio_help_d_rclick_seg:   '색상, 효과, 밝기 변경 또는 삭제',
    studio_help_k_drag:         '세그먼트 드래그',
    studio_help_d_drag:         '타임라인에서 이동',
    studio_help_k_ctrldrag:     'Ctrl + 드래그',
    studio_help_d_ctrldrag:     '인접 세그먼트에 붙지 않고 자유롭게 이동',
    studio_help_d_delete:       '선택한 세그먼트 삭제',
    studio_help_k_ctrlclick:    'Ctrl + 클릭',
    studio_help_d_ctrlclick:    '여러 세그먼트 선택',
    studio_help_d_copy:         '커서 위치에 세그먼트 복사 / 붙여넣기',
    studio_help_k_ruler:        '눈금자 드래그',
    studio_help_d_ruler:        '타임라인 이동 · 클릭하여 이동',
    studio_help_mobile:         '⚠️ 키보드, 우클릭, Ctrl 단축키는 휴대폰에서 사용할 수 없습니다. 휴대폰에서는: 🎨 버튼을 눌러 색상을 추가하고, 세그먼트를 탭하여 선택하며, 길게 눌러 옵션(색상, 효과, 삭제)을 확인하세요. 최상의 경험을 위해 키보드와 마우스가 있는 컴퓨터를 사용하세요.',
    player_log:         '프로토콜 로그',
